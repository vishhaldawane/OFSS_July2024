...
public class InheritanceTest {
	public static void main(String[] args) {
		Person personObj = new Person('F',"Jane",23,"123456781234", "Jane Dsouza", "West Avenue, Bandra, 400020", "9820445678");
		...
		Student student = new Student('F',"Julie",25,1234,"111133334444", "Julie Dmello", "Sadashiv Peth, Pune, 411011", "8877664434");
...
class Person extends Human { //isA - single level
	...
	private String name;
	private int age;
	private AadharCard aadhar = new AadharCard(); //hasA
	...
	public Person(char gender, String name, int age, String aadharNumber, String aadharName, String aadharAddress, String phoneNumber) {
		//super();
		this(gender,name,age); //reuse - the ctor of this class
	
		aadhar.setAadharCard(aadharNumber, aadharName, aadharAddress, phoneNumber);
	}
...
class Student extends Person//isA - multi-level
{
	...
	public Student(char gender, String name, int age, int rollNumber,String aadharNumber, String aadharName, String aadharAddress, String phoneNumber) {
		super(gender, name, age, aadharNumber, aadharName, aadharAddress, phoneNumber);
		this.rollNumber = rollNumber;
...
class RightAngledTriangle extends Triangle
{
	...
	RightAngledTriangle(int s1) {
		super(s1);
		//processing the boolean here 
	}
	RightAngledTriangle(int s1,int s2) {
		super(s1,s2);
		//processing the boolean here 

	}
	RightAngledTriangle(int s1,int s2, int s3) {
		super(s1,s2,s3);
		//processing the boolean here 

	}
	RightAngledTriangle(int s1,int s2, boolean status) {
		 //this(s1,s2);
		 super(s1,s2); //rely upon super class
		 //logic of status
	}
}
